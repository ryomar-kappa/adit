...
final charge1 = MembersCharge.from(
    HRID(hrid: '101284'),
    YearMonth(year: 2024, month: 1),
    [Charge(projectName: ProjectName(value: 'Tiger'), amount: 100)]);

final charge2 =
    MembersCharge.from(HRID(hrid: '101284'), YearMonth(year: 2024, month: 2), [
...
class ChargeRepository {
  Future<List<MembersCharge>> fetchChargeByHrid(HRID hrid) async {
